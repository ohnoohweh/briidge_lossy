...
- current runtime-health coverage pins the portable Core record/ring/file contract and the Python, Linux Swift, macOS Swift, and iOS owners' redacted retained-lifetime wiring, including clean-versus-unclean restart classification without retaining protected traffic
