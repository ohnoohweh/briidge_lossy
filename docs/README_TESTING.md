...
- current telemetry coverage pins empty nonblocking drains, recovery after a failed background flush worker, redacted Admin worker-liveness reporting, and the 15-second load schedule while retaining all spool and HTTPS work outside forwarding callbacks
