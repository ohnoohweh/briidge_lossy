...
pytest -q tests/integration/test_overlay_e2e.py -k myudp_runtime_probe_recovers_composed_loss_delay_reordering_and_duplication
...
| `test_overlay_e2e_python_peer_linux_swift_myudp_runtime_probe_recovers_composed_loss_delay_reordering_and_duplication` | `REQ-MYU-001`, `REQ-MYU-002`, `REQ-MYU-005`, `REQ-MYU-006`, `ARC-CMP-001` | The built foreground Linux Swift client recovers when an independent Python peer composes repeated DATA loss with delayed, duplicated, reverse-ordered multi-datagram replies |
