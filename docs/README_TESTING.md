...
- current telemetry coverage pins empty nonblocking drains, recovery after a failed background flush worker, redacted Admin worker-liveness reporting, the 15-second load schedule, and the iOS-scripted password-protected Keychain identity export and verified Documents staging while retaining all spool and HTTPS work outside forwarding callbacks
