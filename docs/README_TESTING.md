...
- current telemetry coverage pins empty nonblocking drains, recovery after a failed background flush worker, redacted Admin worker-liveness reporting, the 15-second load schedule, and a password-protected iPhone Keychain identity export while retaining all spool and HTTPS work outside forwarding callbacks
