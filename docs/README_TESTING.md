...
- ChannelMux Python/Swift parity fixtures use explicit inbound DATA and CLOSE counters for server channels, preserving the portable Core counter/replay contract in those delivery and close cases.
