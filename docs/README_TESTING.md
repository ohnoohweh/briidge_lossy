...
| `tests/unit/test_runner_config_persistence.py` | `ARC-CMP-004` | `REQ-ADM-009`, `PROC-TST-002` | Runtime config updates must persist registered sections, discard the retired `misc` section, protect saved secrets, and keep telemetry endpoints, labels, identifiers, and paths as visible operational values | `pytest -q tests/unit/test_runner_config_persistence.py` |
...
| `tests/unit/test_runner_config_persistence.py` | Config update persistence | Verify config updates persist registered sections, discard the retired `misc` section, protect saved secrets, and keep telemetry operational values editable | `pytest -q tests/unit/test_runner_config_persistence.py` |
