...
contracts. A shared Python-derived fixture pins TCP malformed records, CKV1
chunk bytes, O4/O5 OPEN, and RS2/RS3 catalog bytes for the Core suite. The macOS Swift probe runs that Core codec suite
