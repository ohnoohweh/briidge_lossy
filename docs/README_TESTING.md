...
Integration coverage currently includes [tests/integration/test_overlay_e2e.py](../tests/integration/test_overlay_e2e.py), [tests/integration/test_linux_elevated.py](../tests/integration/test_linux_elevated.py), [tests/integration/test_macos_elevated.py](../tests/integration/test_macos_elevated.py), [tests/integration/test_macos_swift_elevated.py](../tests/integration/test_macos_swift_elevated.py), [tests/integration/test_windows_elevated.py](../tests/integration/test_windows_elevated.py), and the smaller focused integration files under `tests/integration/`; together they collect `206` tests.
