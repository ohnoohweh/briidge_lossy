...
pytest -q tests/integration/test_overlay_e2e.py -k myudp_runtime_probe_recovers_composed_faults_across_counter_rollover
...
| `test_overlay_e2e_python_peer_linux_swift_myudp_runtime_probe_recovers_composed_faults_across_counter_rollover` | `REQ-MYU-001`, `REQ-MYU-002`, `REQ-MYU-005`, `REQ-MYU-006`, `ARC-CMP-001` | The built foreground Linux Swift client recovers when an independent Python peer composes repeated DATA loss with delayed, duplicated, reverse-ordered multi-datagram replies across the `65535 -> 1` counter rollover |
