...
contracts. A shared Python-derived fixture pins TCP malformed records and CKV1
chunk bytes for the Core suite. The macOS Swift probe runs that Core codec suite
