...
| `R005.5c-3` Reconnect/fresh epoch | In progress | TCP, WebSocket, and myUDP reconnect to independent Python peers with new SecureLink sessions. Reject stale protected data from the retired session at every adapter boundary. |
