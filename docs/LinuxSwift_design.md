...
| `R005.5c-3` Reconnect/fresh epoch | In progress | TCP and WebSocket reconnect to independent Python peers with new SecureLink sessions. Add myUDP, then reject stale protected data from the retired session at every adapter boundary. |
