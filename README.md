...
- Apple SecureLink delegates PSK derivation, proofs, and protected-frame AEAD to the pinned Core `Crypto` surface; generated projects remove stale references to deleted Core-migrated compatibility facades, while its lifecycle runtime remains explicitly separate during the shared-state migration.
