...
- Apple SecureLink delegates PSK derivation, proofs, and protected-frame AEAD to the pinned Core `Crypto` surface; its lifecycle runtime remains explicitly separate while the shared-state migration continues.
