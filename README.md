...
- Apple SecureLink codec ownership delegates PSK transcript byte construction to a CryptoKit-free Core source; its backend calls, lifecycle runtime, and CryptoKit protected-frame calls remain explicitly separate while the shared-state migration continues.
