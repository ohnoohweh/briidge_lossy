...
- **Linux Swift build baseline**: an initial, incomplete, experimental Swift
  ...
  APP/PING/PONG frame codecs, CKV1 control-chunk policy, O5 OPEN and RS3 service
  catalog encoding rather than compiling parallel implementations;
...
| iOS app/extension | `10/92 = 10.9%` | `21/92 = 22.8%` | `24/92 = 26.1%` |
