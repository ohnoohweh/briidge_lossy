...
- Keep Python listener-mode TUN recovery covered: each configured local TUN listener announces `OPEN` after authenticated overlay readiness and before its first packet.
