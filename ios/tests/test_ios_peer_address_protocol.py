...
def test_ios_peer_address_protocol_reflects_ipv4_and_ipv6_without_delivering_control(tmp_path: Path) -> None:
    ...
    probe.write_text(textwrap.dedent("""
        ...
        struct PeerAddressProtocolProbe {
            static func reflected(_ host: String, port: Int) -> String {
                ...
                let reply = server.handleInboundFrame(request, observedPeerHost: host, observedPeerPort: port)
                _ = client.handleInboundFrame(reply.emittedFrames.first!)
                return "\\(client.observedPublicIP):\\(client.observedPublicPort ?? 0)"
            }
            ...
            static func main() throws {
                ...
                let output: [String: Any] = [
                    "ipv4": reflected("198.51.100.44", port: 51044),
                    "ipv6": reflected("2001:db8::44", port: 51045),
                    "mapped_ipv4": reflected("::ffff:198.51.100.44", port: 51046),
    ...
    assert json.loads(output.stdout) == {
        "ipv4": "198.51.100.44:51044",
        "ipv6": "2001:db8::44:51045",
        "mapped_ipv4": "198.51.100.44:51046",
