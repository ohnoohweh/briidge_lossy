...
final class ObstacleBridgeTunnelControl: NSObject {
    ...
    private static let providerBuildTimestampUTC = "2026-05-31T07:23:51Z"
...
private final class ObstacleBridgeIOSAppAdminWebProxy {
    ...
    private let server: ObstacleBridgeWebAdminServer
    ...
    private func apiResponse(method: String, path: String, headers: [String: String], body: Data?) -> ObstacleBridgeAdminAPIResponse? {
        guard let response = providerAdminAPIResponse(method: method, path: path, headers: headers, body: body) else {
    ...
    private func providerAdminAPIResponse(
        ...
        guard let response = providerMessage(payload) else {
            return nil
        }
