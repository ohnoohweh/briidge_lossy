...
CASES: Dict[str, Case] = {
    'case01_udp_over_own_udp_ipv4': Case(
        ...
        bridge_client_args=['--udp-bind', '0.0.0.0', '--udp-peer', '127.0.0.1', '--udp-peer-port', '14443', '--udp-own-port', '0', '--own-servers', 'udp,16667,0.0.0.0,udp,127.0.0.1,16666', '--log', 'INFO', '--log-channel-mux', 'DEBUG', '--log-udp-session', 'DEBUG', '--log-file', 'br_client_ipv4.txt'],
    ),
    'case02_udp_over_own_udp_overlay_ipv6_clients_ipv4': Case(
        ...
        bridge_client_args=['--udp-bind', '::', '--udp-peer', '::1', '--udp-peer-port', '14443', '--udp-own-port', '0', '--own-servers', 'udp,16667,0.0.0.0,udp,127.0.0.1,16666', '--log', 'INFO', '--log-channel-mux', 'DEBUG', '--log-udp-session', 'DEBUG', '--log-file', 'br_client_ipv6.txt'],
    ),
    'case03_udp_over_own_udp_overlay_ipv6_clients_ipv6': Case(
        ...
        bridge_server_args=['--udp-bind', '::', '--udp-own-port', '14443', '--log', 'INFO', '--log-channel-mux', 'DEBUG', '--log-udp-session', 'DEBUG', '--log-file', 'br_server_ipv6.txt'],
        bridge_client_args=['--udp-bind', '::', '--udp-peer', '::1', '--udp-peer-port', '14443', '--udp-own-port', '0', '--own-servers', 'udp,16667,::,udp,::1,16666', '--log', 'INFO', '--log-channel-mux', 'DEBUG', '--log-udp-session', 'DEBUG', '--log-file', 'br_client_ipv6.txt'],
    ),
