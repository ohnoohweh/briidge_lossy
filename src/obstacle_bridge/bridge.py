...
from .bridge_connection_lifecycle import ConnectionLifecycleEvent, ConnectionRotationResult
...
class ISession(Protocol):
    ...
    def set_on_connection_lifecycle(self, cb: Callable[[ConnectionLifecycleEvent], None]) -> None: ...
    ...
    def get_connection_layers_snapshot(self) -> List[dict[str, Any]]: ...
