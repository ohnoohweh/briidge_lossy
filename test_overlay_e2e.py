...
CASES: Dict[str, Case] = {
    ...
    'case02_udp_over_own_udp_overlay_ipv6_clients_ipv4': Case(
        ...
        bounce_proto='udp', bounce_bind='0.0.0.0', bounce_port=16666,
        probe_proto='udp', probe_host='127.0.0.1', probe_port=16667, probe_bind='0.0.0.0',
        bridge_server_args=['--bind443', '::', '--port443', '443', '--log', 'INFO', '--log-channel-mux', 'DEBUG', '--log-udp-session', 'DEBUG', '--log-file', 'br_server_ipv6.txt'],
        bridge_client_args=['--bind443', '::', '--peer', '::1', '--peer-port', '443', '--port443', '0', '--own-servers', 'udp,16667,0.0.0.0,udp,127.0.0.1,16666', '--log', 'INFO', '--log-channel-mux', 'DEBUG', '--log-udp-session', 'DEBUG', '--log-file', 'br_client_ipv6.txt'],
    ),
    'case03_udp_over_own_udp_overlay_ipv6_clients_ipv6': Case(
        name='case03_udp_over_own_udp_overlay_ipv6_clients_ipv6',
        bounce_proto='udp', bounce_bind='::', bounce_port=16666,
        probe_proto='udp', probe_host='::1', probe_port=16667, probe_bind='::',
        bridge_server_args=['--bind443', '::', '--port443', '443', '--log', 'INFO', '--log-channel-mux', 'DEBUG', '--log-udp-session', 'DEBUG', '--log-file', 'br_server_ipv6.txt'],
        bridge_client_args=['--bind443', '::', '--peer', '::1', '--peer-port', '443', '--port443', '0', '--own-servers', 'udp,16667,::,udp,::1,16666', '--log', 'INFO', '--log-channel-mux', 'DEBUG', '--log-udp-session', 'DEBUG', '--log-file', 'br_client_ipv6.txt'],
    ),
    'case04_tcp_over_own_udp_clients_ipv4': Case(
        ...
        bridge_server_args=['--bind443', '0.0.0.0', '--port443', '443', '--log', 'INFO', '--log-channel-mux', 'DEBUG', '--log-udp-session', 'DEBUG', '--log-file', 'br_server.txt'],
        bridge_client_args=['--bind443', '0.0.0.0', '--peer', '127.0.0.1', '--peer-port', '443', '--port443', '0', '--own-servers', 'tcp,3129,0.0.0.0,tcp,127.0.0.1,3128', '--log', 'INFO', '--log-channel-mux', 'DEBUG', '--log-udp-session', 'DEBUG', '--log-file', 'br_client.txt'],
    ),
    'case05_tcp_over_own_udp_clients_ipv6': Case(
        ...
        bridge_server_args=['--bind443', '0.0.0.0', '--port443', '443', '--log', 'INFO', '--log-channel-mux', 'DEBUG', '--log-udp-session', 'DEBUG', '--log-file', 'br_server.txt'],
        bridge_client_args=['--bind443', '0.0.0.0', '--peer', '127.0.0.1', '--peer-port', '443', '--port443', '0', '--own-servers', 'tcp,3129,::,tcp,::1,3128', '--log', 'INFO', '--log-channel-mux', 'DEBUG', '--log-udp-session', 'DEBUG', '--log-file', 'br_client.txt'],
    ),
    ...
    'case07_overlay_tcp_ipv6': Case(
        ...
        bounce_proto='udp', bounce_bind='0.0.0.0', bounce_port=16666,
        probe_proto='udp', probe_host='127.0.0.1', probe_port=16667, probe_bind='0.0.0.0',
        bridge_server_args=['--overlay-transport', 'tcp', '--bind443', '::', '--port443', '12345', '--log', 'INFO', '--log-channel-mux', 'DEBUG', '--log-udp-session', 'DEBUG', '--log-file', 'br_server.txt'],
        bridge_client_args=['--overlay-transport', 'tcp', '--peer', '::1', '--peer-port', '12345', '--bind443', '::', '--port443', '0', '--own-servers', 'udp,16667,0.0.0.0,udp,127.0.0.1,16666', '--log', 'INFO', '--log-channel-mux', 'DEBUG', '--log-udp-session', 'DEBUG', '--log-file', 'br_client_ipv6.txt'],
    ),
    ...
    'case09_overlay_ws_ipv6': Case(
        ...
        bounce_proto='udp', bounce_bind='0.0.0.0', bounce_port=16666,
        probe_proto='udp', probe_host='127.0.0.1', probe_port=16667, probe_bind='0.0.0.0',
        bridge_server_args=['--overlay-transport', 'ws', '--bind443', '::', '--port443', '54321', '--log', 'INFO', '--log-channel-mux', 'DEBUG', '--log-udp-session', 'DEBUG', '--log-file', 'br_server.txt'],
        bridge_client_args=['--overlay-transport', 'ws', '--peer', '::1', '--peer-port', '54321', '--bind443', '::', '--port443', '0', '--own-servers', 'udp,16667,0.0.0.0,udp,127.0.0.1,16666', '--log', 'INFO', '--log-channel-mux', 'DEBUG', '--log-udp-session', 'DEBUG', '--log-file', 'br_client_ipv6.txt'],
    ...
    'case11_overlay_quic_ipv6': Case(
        ...
        bounce_proto='udp', bounce_bind='0.0.0.0', bounce_port=16666,
        probe_proto='udp', probe_host='127.0.0.1', probe_port=16667, probe_bind='0.0.0.0',
        bridge_server_args=['--overlay-transport', 'quic', '--bind443', '::', '--port443', '4443', '--quic-cert', 'cert.pem', '--quic-key', 'key.pem', '--log', 'INFO', '--log-channel-mux', 'DEBUG', '--log-udp-session', 'DEBUG', '--log-file', 'br_server.txt'],
        bridge_client_args=['--overlay-transport', 'quic', '--peer', '::1', '--peer-port', '4443', '--bind443', '::', '--port443', '0', '--quic-insecure', '--own-servers', 'udp,16667,0.0.0.0,udp,127.0.0.1,16666', '--log', 'INFO', '--log-channel-mux', 'DEBUG', '--log-udp-session', 'DEBUG', '--log-file', 'br_client_ipv6.txt'],
    ),
}
...
def main() -> int:
    ...
    print(f'udp_bidirectional_main.py: {BRIDGE}')
