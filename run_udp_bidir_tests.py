...
import udp_bidirectional_transfer as mod
...
from udp_bidirectional_transfer import PROTO, PTYPE_DATA
...
# CONTROL recognizer
from udp_bidirectional_transfer import PROTO, PTYPE_CONTROL
...
class _ControlMonitorWrapper:
    ...
    def _check_full_missed(self, data: bytes):
        try:
            ...
            from udp_bidirectional_transfer import CONTROL_MAX_MISSED
