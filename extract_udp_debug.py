...
# ChannelMux v2 header according to udp_bidirectional_main.py (>HBHBH):
# chan_id(2), proto(1), counter(2), mtype(1), data_len(2)
MUX_HDR = struct.Struct(">HBHBH")

PROTO_NAME = {0: "UDP", 1: "TCP"}                 # from udp_bidirectional_main.py
MTYPE_NAME = {0: "DATA", 1: "OPEN", 2: "CLOSE"}   # from udp_bidirectional_main.py
